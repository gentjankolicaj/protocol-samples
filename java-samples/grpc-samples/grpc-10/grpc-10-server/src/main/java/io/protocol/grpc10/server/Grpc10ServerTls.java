...
public class Grpc10ServerTls {
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      ...
      ServerCredentials serverCredentials = TlsServerCredentials.create(
          Grpc10ServerTls.class.getResourceAsStream("/server.crt"),
          Grpc10ServerTls.class.getResourceAsStream("/server.pem"));
