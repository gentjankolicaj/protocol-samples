package io.protocol.grpc09.server;
    ...
    return new StreamObserver<AverageRequest>() {
      ...
      public void onCompleted() {
        ...
        DoubleSummaryStatistics summaryStatistics = numbers.stream()
            .mapToDouble(e -> e.doubleValue()).summaryStatistics();

        //Sent response & close connection
        responseObserver.onNext(
            AverageResponse.newBuilder().setAverage(summaryStatistics.getAverage()).build());
