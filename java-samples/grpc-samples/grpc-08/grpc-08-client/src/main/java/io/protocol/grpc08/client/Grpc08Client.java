...
public class Grpc08Client {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    List<Float> numbers = Arrays.asList(1.0f, 2.2f, 3.2f, 4.3f, 20f, 10f, 222f, 2f, 23f, 322f, 2f,
        20f, 220f, 0f);

    //Sent a stream of floats to server
    numbers.stream()
        .forEach(e -> toServerStream.onNext(MaxRequest.newBuilder().setNumber(e).build()));
