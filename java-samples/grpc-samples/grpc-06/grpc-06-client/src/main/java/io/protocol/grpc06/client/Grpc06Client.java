...
public class Grpc06Client {
  ...
  public static void main(String[] args) {
    ...
    PrimeServiceGrpc.PrimeServiceBlockingStub stub = PrimeServiceGrpc.newBlockingStub(
        managedChannel);
    Iterator<PrimeResponse> responseIterator = stub.primes(
        PrimeRequest.newBuilder().setNumber(567890).build());
